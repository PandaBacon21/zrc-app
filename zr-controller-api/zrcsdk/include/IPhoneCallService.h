...
public:
     ...
     *
     * @param succeeded TURE indicates answer the incoming SIP call successfully. Otherwise not.
     * @param sipCallInfo The SIP call which is answered.
     * @param accepted TURE indicates accept the incoming SIP call. Otherwise not.
     */
